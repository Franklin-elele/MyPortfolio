    ...
    <div className="Home-container">
      ...
      >
        ...
        <div className="project-cards">
          {[ 
            { href: "https://bib-s-bible-quote-app.vercel.app/", img: bib, title: "Bib's Bible Quote App", desc: "React app to search and view Bible quotes." },
            { href: "https://whitespace-mu.vercel.app/", img: cards, title: "WhiteSpace", desc: "Generate business card from filling in form details." },
            { href: "#", img: Student, title: "Student Card generator", desc: "Create student card from their data." }
          ].map((proj, i) => (
            <motion.a
              key={i}
              href={proj.href}
      ...
      >
        ...
        <div className="social-links">
          <a href="https://www.linkedin.com/in/ebuka-elele-77ab09305/"><SiLinkedin /></a>
